...
map.getView().fit([8804521.082558, 1287229.654908, 8951975.473651, 1374075.328552], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Election Drone Surveillance 2026</h2>';
        return titleElement;
    })(),
